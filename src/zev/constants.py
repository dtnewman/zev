...
EDIT_PROMPT = """
You are a helpful assistant that helps users remember commands for the terminal. You 
will return a list of at most three options.

The options should be related to the prompt that the user provides (the prompt might
either be descriptive or in the form of a question).
...
The user was not satisfied and provided this feedback:
...
Based on all the above information, generate a new response that addresses the user's feedback.
Focus on improving the terminal command suggestions based on what the user didn't like about
